...
namespace ImageLoader
{
    public partial class App : Application
    {
        ...
        public static ImageSource DefaultImage()
        {
            ...
            {
                _defaultImage = new BitmapImage(new Uri(@"/Assets/default_profile_male.png", UriKind.RelativeOrAbsolute));
                ((BitmapImage)_defaultImage).CreateOptions = BitmapCreateOptions.None;
            }
